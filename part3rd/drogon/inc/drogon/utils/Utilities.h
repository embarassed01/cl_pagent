...
/// @brief Generate randome a string
/// @param length The string length 
/// @return The returned string consists of uppercase and lowercase letters and numbers
DROGON_EXPORT std::string genRandomString(int length);

/// @brief Convert a binary string to hex format
/// @param ptr 
/// @param length 
/// @param lowerCase 
/// @return 
...
/// @brief Get a binary string from hexadecimal format
/// @param ptr 
/// @param length 
/// @return 
DROGON_EXPORT std::string hexToBinaryString(const char *ptr, size_t length);

/// @brief Get a binary vector from hexadecimal format
/// @param ptr 
/// @param length 
/// @return 
...
/// @brief Get the encoded length of base64.
/// @param in_len 
/// @param padded 
/// @return 
...
/// @brief Encode the string to base64 format.
/// @param bytesToEncode 
/// @param inLen 
/// @param outputBuffer
/// @param urlSafe 
                                    ...
                                    bool padded = true)
{
    ...
    base64Encode(bytesToEncode, inLen, (unsigned char *)ret.data(), urlSafe, padded);
    return ret;
}
...
/// @brief Encode the string to base64 format with no padding.
/// @param bytesToEncode 
/// @param inLen 
/// @param outputBuffer 
/// @param urlSafe 
...
inline std::string base64EncodeUnpadded(std::string_view data, bool urlSafe = false) 
{
    return base64Encode(data, urlSafe, false);
}

/// @brief Get the decoded length of base64.
/// @param inLen 
/// @return 
...
/// @brief Decode the base64 format string.
/// @param encodedString 
/// @param inLen 
/// @param outputBuffer 
...
/// @brief Check if the string need decoding
/// @param begin 
/// @param end 
/// @return 
DROGON_EXPORT bool needUrlDecoding(const char *begin, const char *end);

/// @brief Decode from or encode to the URL format string
/// @param begin 
/// @param end 
/// @return 
...
/// @brief Get the MD5 digest of a string.
/// @param data 
/// @param dataLen 
/// @return 
...
/// @brief Recursively create a file system path
/// @param path 
/// @return Return 0 or -1 on success of failure.
