 ...
 */
#ifndef DATE_H_TLKIT__
#define DATE_H_TLKIT__
...
namespace trantor {
    ...
    public:
        ...
        /**
         * @brief Construct a new Data instance.
         * 
         * @param year
         * @param month
         * @param day
        ...
        static int64_t timezoneOffset() {
            static int64_t offset = -(Date::fromDbStringLocal("1970-01-03 00:00:00").secondsSinceEpoch() - 2LL * 3600LL * 24LL);
            return offset;
        }
        ...
        /**
         * @brief Return a new Date instance that equals to *this, but with zero microseconds.
         * 
         * @return const Date
         */
        ...
        /**
         * @brief Return a new Date instance that equals to *this, but with zero hours, minutes, seconds and microseconds.
         * 
         * @return const Date
         */
         ...
         * @return int64_t
         */
        int64_t secondsSinceEpoch() const { return microSecondsSinceEpoch_ / MICRO_SECONDS_PRE_SEC; }
         ...
         *
         * @param fmtStr The format string.
         * @param str The string buffer for the generated time string.(output)
         * @param len The length of the string buffer.
         */
        void toCustomFormattedString(const std::string &fmtStr, char *str, size_t len) const;  // UTC
