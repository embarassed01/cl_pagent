#ifndef _TIMEINGWHEEL_H_TLKIT__
#define _TIMEINGWHEEL_H_TLKIT__
...
namespace trantor {
    ...
    /**
     * @brief This class implements a timer strategy with high performance and low accuracy. This is usually used internally.
     */
    ...
    public:
         ...
         * @param ticksInterval The internal timer tick interval. It affects the accuracy of the timing wheel.
         * @param bucketsNumPerWheel The number of buckets per wheel.
         * @note The max delay of the timing wheel is about ticksInterval*(bucketsNumPerWheel^wheelsNum) seconds.
         * @note Example: Four wheels with 200 buckets per wheel means the timing wheel can work with a timeout up to 200^4 seconds, about 50 years;
         */
        ...
        void insertEntryInloop(size_t delay, EntryPtr entrPtr);
