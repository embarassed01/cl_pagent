#ifndef _MSGBUFFER_H_TLKIT__
#define _MSGBUFFER_H_TLKIT__
...
namespace trantor {
    ...
    public:
         ...
         * @return ssize_t The number of bytes read from the file descriptor. -1 is returned when an error occurs.
         */
        ...
        /**
         * @brief Move the write pointer forward when the new data has been written to the buffer. 
         * @param len
         */
        ...
        /**
         * @brief Move the write pointer backward to remove data in the end of the buffer. 
         * @param offset
         */
