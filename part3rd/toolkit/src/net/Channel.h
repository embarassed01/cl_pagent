#ifndef _CHANNEL_H__TLKIT__
#define _CHANNEL_H__TLKIT__
...
namespace trantor {
    ...
    /**
     * @brief This class is used to implement reactor pattern. A Channel object manages a socket fd. Users use a Channel object to receive write or read events on the socket it manages.
     * 
     */
    ...
    public:
         ...
         * @note One should call the enableReading() method to ensure that the callback would be called when some data is received on the socket.
         */
         ...
         * @note One should call the enableWriting() method to ensure that the callback would be called when the socket can be written.
         */
         ...
         * @note If the event callback is set to the channel, any other callback wouldn't be called again.
         */
        ...
        /**
         * @brief This method is used to ensure that the callback owner is valid when a callback is called.
         * 
         * @param obj The callback owner. Usually, the owner is also the owner of the channel.
         * @note The 'obj' is kept in a `weak_ptr` object, so this method does not cause a circular reference problem.
         */
