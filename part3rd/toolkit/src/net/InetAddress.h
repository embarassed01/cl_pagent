#ifndef _INETADDRESS_H_TLKIT__
#define _INETADDRESS_H_TLKIT__
...
namespace trantor {
    ...
    public:
        ...
        /**
         * @brief Constructs an endpoint with given struct `sockaddr_in`. Mostly used when accepting new connections
         * @param addr
         */
        ...
        /**
         * @brief Return the port nubmer of the endpoint.
         * @return uint16_t
         */
        ...
        /**
         * @brief Return true if the endpoint is an intranet内联网 endpoint.
         *
         * @return true
         * @return false
         */
